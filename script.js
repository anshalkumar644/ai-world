...
function transitionToMainInterface() {
    ...
    setTimeout(() => {
        ...
        if (SpeechRecognition && recognition) {
            ...
            speak("क्षमा करें, आपका ब्राउज़र स्पीच रिकॉग्निशन का समर्थन नहीं करता है। आप टाइप करके बातचीत कर सकते हैं।");
        }
        userInput.focus();
    }, 1000);
}
...
if (SpeechRecognition) {
    ...
    recognition.onerror = (event) => {
        ...
        if (event.error === 'not-allowed') {
            ...
            errorMessage = "कोई आवाज़ नहीं सुनी गई। कृपया फिर से प्रयास करें।";
        }
...
async function sendMessage() {
    ...
    const isLikelyAnswer = lastQuestionAsked && userText.length < 50 &&
                           ...
                           !userText.toLowerCase().includes('मुझसे प्रश्न पूछो');
    ...
    try {
        const apiKey = "AIzaSyC1N0DW220j1CR7sdBVocTTvCTKaFo_g7o"; // आपकी API कुंजी यहाँ जोड़ी गई है
        ...
        const errorMessage = "क्षमा करें, AI से कनेक्ट करने में कोई समस्या आ गई है। कृपया कुछ देर बाद पुनः प्रयास करें।";
...
homeLink.addEventListener('click', (event) => {
    ...
    displayChatMessage("आप होम पेज पर हैं।", 'ai');
    speak("आप होम पेज पर हैं।");
});

aboutLink.addEventListener('click', (event) => {
    event.preventDefault(); // Prevent default link behavior
    dropdownParent.classList.remove('active'); // Close dropdown
    const aboutText = "नमस्ते! मेरा नाम अंशल कुमार है। मुझे अंशल कुमार द्वारा बनाया गया है। मैं एक स्मार्ट लर्निंग AI हूँ और मैं आपको पढ़ाई में सहायता कर सकता हूँ। अगर आप मुझे इस्तेमाल करते हैं, तो आप किसी भी परीक्षा में आसानी से पास हो सकते हैं। आप मेरे साथ अपना भविष्य बना सकते हैं।";
...
contactLink.addEventListener('click', (event) => {
    ...
    const subject = 'AI World App से संपर्क';
    const body = 'नमस्ते अंशल कुमार,\n\nमैं आपके AI World App के बारे में आपसे संपर्क करना चाहता हूँ।\n\nधन्यवाद,';
    const mailtoLink = `mailto:${email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    window.open(mailtoLink, '_blank'); // Open email client in a new tab
    displayChatMessage(`आप ईमेल भेज सकते हैं: ${email}`, 'ai');
});
...
helpLink.addEventListener('click', (event) => {
    ...
    const helpText = `
        सहायता:
        1. माइक्रोफ़ोन काम नहीं कर रहा है?
           - सुनिश्चित करें कि आपके ब्राउज़र को माइक्रोफ़ोन एक्सेस की अनुमति है।
           - अपने सिस्टम सेटिंग्स में माइक्रोफ़ोन की जाँच करें।
           - एक शांत वातावरण में बोलें।
        2. AI जवाब नहीं दे रहा है?
           - सुनिश्चित करें कि आपके पास एक स्थिर इंटरनेट कनेक्शन है।
           - 'शुरू करें' बटन पर क्लिक करके AI को सक्रिय करें।
           - यदि समस्या बनी रहती है, तो पेज को रीफ़्रेश करें।
        3. आवाज़ नहीं आ रही है?
           - सुनिश्चित करें कि आपके डिवाइस का वॉल्यूम चालू है।
           - अपने ब्राउज़र की ऑडियो सेटिंग्स की जाँच करें।
    `;
    displayChatMessage(helpText, 'ai');
    speak("सहायता अनुभाग खुल गया है।");
});
